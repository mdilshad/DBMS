...
<li id="current" class="active item66"><a href="facilities.php"><span>Facilities</span></a></li></ul></li>
...
<a href="Welcome.php" class="pathway">Home</a> <img src="placement/arrow.png" alt=""> <a href="recruit.php" class="pathway">Why Recruit @ NITC</a> <img src="placement/arrow.png" alt=""> Facilities</span>
<table class="contentpaneopen">
<tbody><tr>
<td class="contentheading" width="100%">Facilities</td>
</tr>
</tbody></table>
<table class="contentpaneopen">
<tbody><tr>
<td colspan="2" valign="top">
<p>Besides our warm welcome, Campus redruiters are given the following aids:</p><ul><li>Large classrooms and Halls for Pre-Placement talks and written tests</li><li>Air Conditioned rooms in the Training &amp; Placement Office for Group Discussions and Interviews.</li><li>High Speed internet connection Facility (for submission of soft copies of resumes, Mails for correspondence, etc.)</li><li>Student Volunteers for prompt actions on the Placement Day.</li><li>Guest house and lodging facilities.&nbsp;</li></ul>
