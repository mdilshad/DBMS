...
<ul>
<li id="current" class="active item70"><a href="vwdept.php"><span>View all</span></a></li>
...
<a href="query.php" class="pathway">Home</a><img src="placement/arrow.png" alt=""><a href="" class="pathway">Department</a><img src="placement/arrow.png" alt=""> Vew all</span>
														
<table class="contentpaneopen"><tbody><tr>
<td class="contentheading" width="100%">Department Details</td></tr>
</tbody></table>
...
<table  style="width: 820px;" cellspacing="12" cellpading="10" border="1"><tbody>
	...
	<?php
			...
			$sql=pg_query("SELECT * FROM dept order by dname");
