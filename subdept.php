...
if (isset($_POST['submit'])) 
{
	...
	if($dname=='')
	{
		$warn1="Enter Department name";
		$count=$count+1;
	}
	else
	{
		$query=pg_query("SELECT dname FROM dept where dname='$dname'");
		$row=pg_fetch_array($query);
		if($dname==$row[0])
		{
			$warn1="Department Already Exist";
			$count=1;
		}
	}	
	if($hod=='')
	{
		$warn2="Enter Head of Department name ";
		$count=$count+1;
	}		
	if($count==0)
		$result=pg_query("insert into dept values('$dname','$hod')");	
	if($result)
	{	
...
<html xml:lang="en-gb" xmlns="http://www.w3.org/1999/xhtml" lang="en-gb"><head>
  <title>Insert Department Detail</title>
...
<ul>
<li id="current" class="active item70"><a href="subdept.php"><span>insert</span></a></li>
...
<a href="web.php" class="pathway">Home</a><img src="placement/arrow.png" alt=""><a href="" class="pathway">Department</a><img src="placement/arrow.png" alt="">Insert</span>
<table class="contentpaneopen"><tbody><tr>
<td class="contentheading" width="100%">Insert Department Details</td></tr>
<tr>
<td class="mod" width="100%"><?php echo $resul; ?></td></tr>
</tbody></table>
<form action="subdept.php" method="post">
	...
	<fieldset>
		...
		<td><input type="text" name="dname" class="box4" value="<?php echo $dname?>"></td>
		<td><span class="mandatory-star"><?php echo $warn1; ?></span></td>
	</tr>
			
	<tr>
      		<td class="text_b2">Head of Department Name<span class="mandatory-star">*</span></td>
