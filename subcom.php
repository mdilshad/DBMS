...
session_start();
	...
	$estd=isset($_POST['estd'])?trim($_POST['estd']):'';$warn3='';
	$mm=isset($_POST['mm'])?$_POST['mm']:'';
	$dd=isset($_POST['dd'])?$_POST['dd']:'';
	$yy=isset($_POST['yy'])?$_POST['yy']:'';
...
if (isset($_POST['submit'])) 
{
	...
	else
	{
		...
		if($comreg==$row[0])
			$warn1="Company Already Exist";
	}
	if($comname=='')
	{
		$warn2="Enter Company name";
		$count=$count+1;
	}
	if($estd=='')
	{
		$warn3="Select Establishment Date";
		$count=1;
	}
	if($speci=='')
	{
		$warn4="Enter company Specification ";
		$count=1;
	}	
	if($count==0)
		$result=pg_query("insert into company values($comreg,'$comname','$estd','$speci')");	
	if($result)
	{	
...
<ul>
<li id="current" class="active item73"><a href="subcom.php"><span>insert</span></a></li>
...
<a href="web.php" class="pathway">Home</a><img src="placement/arrow.png" alt=""><a href="" class="pathway">Company</a><img src="placement/arrow.png" alt=""> Insert</span>
<table class="contentpaneopen"><tbody><tr>
<td class="contentheading" width="100%">Insert Company Details</td></tr>
<tr>
...
<form action="subcom.php" method="post">
	...
	<fieldset>
		...
		<td><span class="mandatory-star"><?php echo $warn1; ?></span></td>
       	...
       	<tr>
          	<td class="text_b2">Company Name <span class="mandatory-star">*</span></td>
          	<td><input type="text" name="comname"  class="box4" value="<?php echo $comname?>"></td>
		<td><span class="mandatory-star"><?php echo $warn2; ?></span></td>
        </tr>
        
        <tr>
          	<td class="text_b2">Estd Date <br>(mm-dd-yyyy) <span class="mandatory-star">*</span></td>
		...
		<td><span class="mandatory-star"><?php echo $warn3; ?></span></td>
         ...
         <tr>
          	<td class="text_b2">Specification <span class="mandatory-star">*</span></td>
