...
<ul>
<li id="current" class="active item73"><a href="vwcom.php"><span>View all</span></a></li>
...
<a href="query.php" class="pathway">Home</a><img src="placement/arrow.png" alt=""><a href="" class="pathway">Company</a><img src="placement/arrow.png" alt=""> View all</span>
														
<table class="contentpaneopen"><tbody><tr>
<td class="contentheading" width="100%">Company Details</td></tr>
</tbody></table>
...
<table  style="width: 820px;" cellspacing="12" cellpading="10" border="1"><tbody>
	<tr><th>Company Reg.</th><th>Company name</th><th>Estd</th><th>Specification</th></tr>
	<?php
			$con=pg_connect("host=localhost port=5432 dbname=placement user=dilshad password=a") or die("could not connect");
			$sql=pg_query("SELECT * FROM company order by name");
