...
<li id="current" class="active item58"><a href="contact.php"><span>Contact Us</span></a></li>
<?php
	require("login.php");
...
<a href="Welcome.php" class="pathway">Home</a> <img src="placement/arrow.png" alt=""> Contact Us</span>
<table class="contentpaneopen" cellspacing="5" cellpadding="5">
<tbody><tr>
<td colspan="2" valign="top">
<strong>Contact Information</strong></div></td>
        </tr>
		<tr>

          <td valign="top">&nbsp;</td>
          <td valign="top"><div id="welcomecontent_archmain">
		 <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="17%" valign="top" class="dpt_link"> Email </td>
              <td width="3%" valign="top"><div align="center">:</div></td>
              <td width="80%" class="dpt_link"><span class="mod">suresh@nitc.ac.in</span></td>

            </tr>
            <tr>
              <td valign="top" class="dpt_link">Contact No </td>
              <td valign="top"><div align="center">:</div></td>
              <td class="dpt_link"><span class="mod">(0495)2286602(O), 09447218770 (M),2287118(R)</span></td>
            </tr>
            <tr>

              <td valign="top" class="dpt_link"> Mailing Address </td>
              <td valign="top"><div align="center">:</div></td>
              <td class="dpt_link"><span class="mod">Professor (Training & Placement)<br />
Department of Training and Placement<br />
N I T Campus Post, NIT Calicut<br />
Calicut - 673 601.</span>
</td>
</tr>
</tbody></table></td>
</tr>
