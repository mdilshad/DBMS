...
<li class="parent active item56"><a href="recruit.php" class="topdaddy"><span>Why Recruit @ NITC</span></a>
<ul>
<li id="current" class="active item65"><a href="alumni.php"><span>Alumni</span></a></li>
...
<a href="Welcome.php" class="pathway">Home</a> <img src="placement/arrow.png" alt=""> <a href="recruit.php" class="pathway">Why Recruit @ NITC</a> <img src="placement/arrow.png" alt=""> Alumni</span>
<table class="contentpaneopen">
<tbody><tr>
<td class="contentheading" width="100%">Alumni</td>	
</tr>
</tbody></table>
...
<p><font color="#000000">With a rich heritage dating back to as far as 
1919 (pioneers of engineering education in the country by being the 
first to start degree courses in Mining, Metallurgy, Ceramics and 
Pharmaceutics) that has been its preserve, it is no wonder that alumni 
of the institute occupy the echelons of the corporate ladder courtesy a 
dynamic, ever-evolving system where priority is placed on improving the 
self and the society and where the sky is set as the limit.</font></p>
<p><font color="#000000">For a list of eminent alumni, visit.. </font></p><p></p>
