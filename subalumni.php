...
session_start();
	...
	$count=0;$resul='';
	$roll_no=isset($_POST['roll_no'])?trim($_POST['roll_no']):'';$warn1='';
	$comname=isset($_POST['comname'])?trim($_POST['comname']):'';$warn2='';
	$package=isset($_POST['package'])?trim($_POST['package']):'';$warn3='';
...
if (isset($_POST['submit'])) 
{
	...
	if($comname==''||!($comname>0))
	{
		$warn2="Enter Company name Numeric";
		$count=1;
	}
	if($comname!='')
	{
		$query=pg_query("SELECT reg_no FROM company where reg_no=$comname");
	...
	{
		$warn3="Enter package Real";
		$count=1;
	}		
	if($count==0)
		$result=pg_query("insert into alumni values('$roll_no',$comname,$package)");
	if($result)
	{	
...
if (isset($_POST['check'])) 
{
	...
	{
		$query=pg_query("SELECT roll_no,name FROM student where roll_no='$roll_no'");
		$row=pg_fetch_array($query);
		if($roll_no!=$row[0])
		{
			$warn1="Student not Exist";
			$warn5='';
		}
		else
			$warn5=$row[1];
...
<html xml:lang="en-gb" xmlns="http://www.w3.org/1999/xhtml" lang="en-gb"><head>
  <title>Insert Alumni Details</title>
<style>
fieldset {
...
<ul>
<li id="current" class="active item64"><a href="subalumni.php"><span>insert</span></a></li>
...
<a href="web.php" class="pathway">Home</a><img src="placement/arrow.png" alt=""> <a href="" class="pathway">Alumni</a><img src="placement/arrow.png" alt="">Insert </span>
<table class="contentpaneopen"><tbody><tr>
<td class="contentheading" width="100%">Insert Alumni Details</td></tr>
<tr>
<td class="mod" width="100%"><?php echo $resul; ?></td></tr>
</tbody></table>
<form action="subalumni.php" method="post">
	...
	<fieldset>
		...
		<td class="text_b2">Student Roll Number <span class="mandatory-star">*</span></td>
          	...
          	<td><span class="mandatory-star"><?php echo $warn1; ?></span><span class="star"><?php echo $warn5; ?></span></td>
        	</tr>	
		...
		<tr>
        	<td class="text_b2">Package <span class="mandatory-star">*</span></td>
